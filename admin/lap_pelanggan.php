...
$pdf->SetFont('Arial','B',14);
	$pdf->Cell(25.5,0.7,"Laporan Data Pelanggan<?php",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(3, 0.8, 'Kota', 1, 0, 'C');
$pdf->Cell(4, 0.8, 'Kontak', 1, 0, 'C');
$pdf->Cell(4.5, 0.8, '', 1, 0, 'C');
$pdf->Cell(4.5, 0.8, '', 1, 0, 'C');
$pdf->Cell(3, 0.8, '', 1, 1, 'C');
...
while($lihat=mysqli_fetch_array($query)){
		...
		$pdf->Cell(3, 0.8, $lihat['kota'], 1, 0,'C');
		$pdf->Cell(4, 0.8, $lihat['nomor_telepon'],1, 0, 'C');
