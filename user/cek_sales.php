...
<h3><span class="glyphicon glyphicon-briefcase"></span> Kinerja Sales</h3>
<!-- <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Barang</button> -->
<br/>
<br/>

<!-- <?php
$periksa=mysqli_query($con,"select * from users where jumlah <=3");
...
<div class="col-md-12">
	...
	<a style="margin-bottom:10px" href="lap_sales.php" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Cetak</a>
</div>
<form action="cari_sales.php" method="get">
...
<table class="table table-hover">
	<tr>
		...
		<th class="col-md-2">Nama Sales</th>
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysqli_query($con,"select * from barang_laku where nama_sales like '$cari'");
	}else{
		$sales = $_SESSION['uname'];
		$brg=mysqli_query($con,"select * from barang_laku where nama_sales = '$sales' limit $start, $per_hal ");
	}
	$no=1;
