...
if(isset($_GET['pesan'])){
	if($_GET['pesan'] == "gagal"){
		echo "<div style='margin-bottom:-55px' class='alert alert-danger' role='alert'><span class='glyphicon glyphicon-warning-sign'></span>  Data pelanggan hanya bisa di edit oleh sales yang melakukan input data pelanggan tersebut !</div>";
	}
}
else if(isset($_GET['pesan'])){
	if($_GET['pesan'] == "sukses"){
		echo "<div style='margin-bottom:-55px' class='alert alert-succes' role='alert'><span class='glyphicon glyphicon-warning-sign'></span>  Data pelanggan berhasil dihapus !</div>";
	}
}
 ?>
