...
<table class="table table-hover">
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysqli_query($con,"select * from barang_laku where nama like '$cari' or jenis like '$cari'");
	}else{
		$brg=mysqli_query($con,"select * from barang_laku limit $start, $per_hal");
	}
	$no=1;
	while($b=mysqli_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				<a href="det_belanja.php?nama_pelanggan=<?php echo $b['nama_pelanggan']; ?>" class="btn btn-info">Detail</a>
        <a href="Invoice.php?id=<?php echo $b['id']; ?>" class="btn btn-warning">Cetak Invoice</a>
